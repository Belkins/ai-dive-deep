...
keyConcepts: ["night shift", "shared .mcp.json", "dual-agent CI", "branch protection", "shift hand-off", "AI Studio", "Gemini ideation"]
readingMinutes: 10
---
