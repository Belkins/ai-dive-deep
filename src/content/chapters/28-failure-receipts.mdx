...
For the next incident, use the [AI agent incident review template](https://vladyslavpodoliako.com/thoughts/ai-agent-incident-review-template) to record impact, containment, the failed control, and its owner. Turn the failure into a regression case in [Chapter 25's artifact gate](/chapters/25-evals-or-hope/) before resuming unattended work.
