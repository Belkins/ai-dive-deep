...
<Callout type="tip">
September 2026 reference: [the current model list and independent comparisons](/tier-list/#sec-models) now cover GPT-6 Astra and Claude Fable 5.1. The May addendum and personal placements below are historical receipts, not current model-release guidance. A new release does not automatically change an operator tier.
</Callout>
