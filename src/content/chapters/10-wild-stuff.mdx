...
<Callout type="tip">
Suno is scoring that cold open by turning sound into a short alphabet of learned symbols and autocompleting it — the same machine that finishes your sentences, pointed at audio. That trick is not a music trick, and it now writes proteins, drives robot arms, and beats the world's best weather forecast. The mechanism, the real numbers, and the three places it's oversold: [Music is Math](/music-is-math/).
</Callout>
