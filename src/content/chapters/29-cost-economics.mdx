...
title: "The Bill, Demystified"
subtitle: "Token math, prompt caching, batch API, model routing — what actually moves your invoice."
...
<ScreenshotPlaceholder
  caption="Anthropic console weekly cost view"
  note="capture the actual graph showing the $4,312 spike and the return-to-baseline week, with cached vs fresh input tokens overlaid, so the cache-miss event is visible."
/>
