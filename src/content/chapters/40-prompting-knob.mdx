...
I'll write the deep version separately — a `/swarms` page is queued for the next edition, with diagrams, examples, and the orchestration patterns I actually use. For this chapter, the load-bearing claim is:
