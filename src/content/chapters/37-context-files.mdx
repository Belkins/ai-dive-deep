...
{/* [VLAD: forward-pointer seam to Ch 44. The clause above — "updates it when something worth remembering happens" — hides the hard problem this chapter doesn't solve: across hundreds of sessions, how does the memory layer stay curated, deduped, and *true*? Suggested ~2 sentences in your voice, linking [Chapter 44](/chapters/44-dreaming): the propose-only loop that surfaces candidate memories without ever letting an agent write a hallucinated one. Delete this comment when voiced. */}
