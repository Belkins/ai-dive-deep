...
export default function CommandPalette() {
  ...
  const items: Item[] = useMemo(() => {
    ...
    const pages: Item[] = [
      ...
      { type: 'page', title: 'Fable 5 API',           href: `${base}/fable-5/api`,      subtitle: 'claude-fable-5 — one-line migration, one new 400',                                                    keywords: 'fable 5 api claude-fable-5 model id migration thinking disabled 400 adaptive effort xhigh context 1m' },
      { type: 'page', title: 'Claude Code best practices', href: `${base}/claude-code-best-practices`, subtitle: 'What survived production — distilled from 45 chapters',                                  keywords: 'claude code best practices tips workflow how to use production practices guide checklist' },
