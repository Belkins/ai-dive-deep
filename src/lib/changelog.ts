...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    shipped: [
      ...
      'Research-notes page redesigned for scannability — twelve fully-expanded notes were a wall. The timeline is now an index (date · title · tagline), each note unfolds on click with the newest open by default, receipts render as an aligned spec sheet instead of a card grid, implications are numbered, and RSS deep-links auto-open the note they point at.',
    ],
    receipts: [
