...
export const LAUNCH_TIMELINE: LaunchEntry[] = [
  {
    ...
    url: '/launch',
    prep: 'Page-as-proof: typewriter hero, animated stat odometer, 3 live embedded artifacts, all 46 chapters as a click-anywhere mosaic, the 13-day timeline, post-credit AFC tease.',
